...
BuildRequires:	libXfixes-devel libXext-devel libdrm-devel mesa-devel libpciaccess-devel
#xorg-server-devel pixman-devel libX11-devel 
Requires:	libXfixes libXext libdrm mesa libpciaccess
#xorg-server pixman libX11 
%description
