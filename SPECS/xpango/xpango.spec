...
BuildRequires:	xcairo-devel libXft-devel harfbuzz-devel gobject-introspection-devel python3-gobject-introspection xfontconfig-devel xfreetype2-devel xfontconfig
...
Requires:	xcairo-devel libXft-devel gobject-introspection-devel python3-gobject-introspection xfontconfig-devel
%description	devel
...
%{_datadir}/*
%changelog
* Tue Aug 03 2021 Alexey Makhalov <amakhalov@vmware.com> 1.40.13-1
- Version update
