...
Provides:	vui
BuildArch:	noarch
Requires:	linux-drivers-gpu lxde-common pygtk gtksourceviewmm lxdm alsa-utils lxterminal firefox thunderbird gpicview grdesktop lxtask pidgin monodevelop pinta tomboy gpicview hicolor-icon-theme banshee gvfs open-vm-tools-vivace 
